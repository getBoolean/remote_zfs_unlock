...
- 🔒 **Lock datasets** - Unmount datasets and unload keys to secure encrypted datasets
...
Try the limited web demo at [https://getboolean.github.io/remote_zfs_unlock/main](https://getboolean.github.io/remote_zfs_unlock/main)
